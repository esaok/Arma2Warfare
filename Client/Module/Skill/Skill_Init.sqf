...
WFBE_SK_V_Engineers = ['USMC_SoldierS_Engineer','MVD_Soldier_TL','US_Soldier_Engineer_EP1','TK_Soldier_Engineer_EP1','CDF_Soldier_Engineer','Ins_Soldier_Sapper','USMC_Soldier_TL','BAF_Soldier_SL_DDPM'];
WFBE_SK_V_Soldiers = ['FR_R','RUS_Soldier1','US_Delta_Force_EP1','TK_Special_Forces_EP1','CDF_Soldier','Ins_Soldier_1'];
WFBE_SK_V_SpecsOps = ['FR_TL','RUS_Soldier_TL','US_Soldier_TL_EP1','US_Delta_Force_TL_EP1','TK_Special_Forces_TL_EP1','CDF_Soldier_TL','Ins_Soldier_2'];
...
WFBE_SK_V_Medics = ['FR_Corpsman','USMC_Soldier_Medic','RU_Soldier_Medic','US_Delta_Force_Medic_EP1','US_Soldier_Medic_EP1','TK_Soldier_Medic_EP1'];
