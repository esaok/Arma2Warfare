...
Private ["_count_old","_count_new","_counts","_difference","_div","_find","_gear","_gear_bp","_gear_mags","_gear_new","_gear_old","_gear_veh","_get","_iprice","_mags","_prefix","_price","_view"];
...
_price = 0;
_div = if (_view == "vehicle") then {0} else {missionNamespace getVariable "WFBE_C_PLAYERS_GEAR_SELL_COEF"};
