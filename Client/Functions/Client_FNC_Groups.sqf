...
WFBE_CL_FNC_UI_Groups_Kick = {
	...
	if (isPlayer _selected && group _selected == group player) then {
		...
		["INFORMATION", Format ["WFBE_CL_FNC_UI_Groups_Kick: Attempting to kick [%1] [%2] out of my group.", name _selected, getPlayerUID _selected]] Call WFBE_CO_FNC_LogContent;
	};
};
