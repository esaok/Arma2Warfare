...
_u =      [["AAV", 50, 2]];
_u = _u + [["BAF_FV510_W", 70, 3]];
_u = _u + [["BAF_FV510_D", 70, 3]];
_u = _u + [["BMP2_CDF", 50, 2]];
_u = _u + [["BMP2_Gue", 50, 2]];
_u = _u + [["BMP2_INS", 50, 2]];
_u = _u + [["BMP2_TK_EP1", 50, 2]];
_u = _u + [["BMP3", 65, 3]];
_u = _u + [["BTR90", 65, 2]];
_u = _u + [["LAV25", 65, 2]];
_u = _u + [["M1126_ICV_M2_EP1", 60, 1]];
_u = _u + [["M1126_ICV_mk19_EP1", 55, 1]];
_u = _u + [["M1129_MC_EP1", 60, 1]];
_u = _u + [["M1135_ATGMV_EP1", 60, 1]];
_u = _u + [["M1128_MGS_EP1", 60, 1]];
_u = _u + [["M1133_MEV_EP1", 60, 1]];
_u = _u + [["M1A1", 70, 4]];
_u = _u + [["M1A1_US_DES_EP1", 70, 4]];
_u = _u + [["M1A2_TUSK_MG", 75, 4]];
_u = _u + [["M1A2_US_TUSK_MG_EP1", 75, 4]];
_u = _u + [["M2A2_EP1", 65, 3]];
_u = _u + [["M2A3_EP1", 65, 3]];
_u = _u + [["M6_EP1", 60, 3]];
_u = _u + [["T72_CDF", 65, 4]];
