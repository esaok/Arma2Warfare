...
/* Infantry */
_c = _c + ['CDF_Soldier'];
_i = _i + [['','',150,4,-1,0,0,1,'CDF',[]]];

_c = _c + ['CDF_Soldier_Engineer'];
_i = _i + [['','',225,5,-1,0,0,1,'CDF',[]]];

_c = _c + ['CDF_Soldier_Light'];
_i = _i + [['','',175,4,-1,0,0,1,'CDF',[]]];

_c = _c + ['CDF_Soldier_GL'];
_i = _i + [['','',180,4,-1,0,0,1,'CDF',[]]];

_c = _c + ['CDF_Soldier_Militia'];
_i = _i + [['','',160,3,-1,0,0,1,'CDF',[]]];

_c = _c + ['CDF_Soldier_Medic'];
_i = _i + [['','',210,4,-1,0,0,1,'CDF',[]]];

_c = _c + ['CDF_Soldier_Sniper'];
_i = _i + [['','',230,5,-1,1,0,1,'CDF',[]]];

_c = _c + ['CDF_Soldier_Spotter'];
_i = _i + [['','',240,6,-1,1,0,1,'CDF',[]]];

_c = _c + ['CDF_Soldier_Marksman'];
_i = _i + [['','',235,7,-1,3,0,1,'CDF',[]]];

_c = _c + ['CDF_Soldier_RPG'];
_i = _i + [['','',250,6,-1,1,0,1,'CDF',[]]];

_c = _c + ['CDF_Soldier_Strela'];
_i = _i + [['','',400,6,-1,2,0,1,'CDF',[]]];

_c = _c + ['CDF_Soldier_AR'];
_i = _i + [['','',165,6,-1,1,0,1,'CDF',[]]];

_c = _c + ['CDF_Soldier_MG'];
_i = _i + [['','',180,5,-1,0,0,1,'CDF',[]]];

_c = _c + ['CDF_Soldier_TL'];
_i = _i + [['','',210,6,-1,2,0,1,'CDF',[]]];

_c = _c + ['CDF_Soldier_Officer'];
_i = _i + [['','',230,7,-1,1,0,1,'CDF',[]]];

_c = _c + ['CDF_Commander'];
_i = _i + [['','',280,7,-1,3,0,1,'CDF',[]]];

_c = _c + ['CDF_Soldier_Pilot'];
_i = _i + [['','',130,5,-1,0,0,1,'CDF',[]]];
...
_c = _c + ['BMP2_CDF'];
_i = _i + [['','',2600,30,-2,0,2,0,'CDF',[]]];

_c = _c + ['ZSU_CDF'];
_i = _i + [['','',3500,35,-2,2,2,0,'CDF',[]]];

_c = _c + ['T72_CDF'];
_i = _i + [['','',5200,35,-2,2,2,0,'CDF',[]]];

/* Air Vehicles */
_c = _c + ['Mi17_CDF'];
_i = _i + [['','',8800,35,-2,1,3,0,'CDF',[]]];

_c = _c + ['Mi17_medevac_CDF'];
_i = _i + [['','',9120,35,-2,1,3,0,'CDF',[]]];

_c = _c + ['Mi24_D'];
_i = _i + [['','',25584,40,-2,3,3,0,'CDF',[]]];
