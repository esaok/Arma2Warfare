...
_c = _c + ['HMMWV'];
_i = _i + [['','',350,15,-2,0,1,0,'USMC',[]]];

_c = _c + ['Zodiac'];
_i = _i + [['','',225,17,-2,1,1,0,'USMC',[]]];

_c = _c + ['HMMWV_M2'];
_i = _i + [['','',620,18,-2,1,1,0,'USMC',[]]];

_c = _c + ['HMMWV_Armored'];
_i = _i + [['','',600,20,-2,2,1,0,'USMC',[]]];

_c = _c + ['HMMWV_MK19'];
_i = _i + [['','',750,22,-2,1,1,0,'USMC',[]]];

_c = _c + ['HMMWV_TOW'];
_i = _i + [['','',1450,20,-2,3,1,0,'USMC',[]]];

_c = _c + ['HMMWV_Avenger'];
_i = _i + [['','',1750,25,-2,4,1,0,'USMC',[]]];

_c = _c + ['HMMWV_Ambulance'];
_i = _i + [['','',4000,22,-2,2,1,0,'USMC',[]]];

_c = _c + ['MTVR'];
_i = _i + [['','',500,20,-2,0,1,0,'USMC',[]]];

_c = _c + ['WarfareSalvageTruck_USMC'];
_i = _i + [['','',750,21,-2,1,1,0,'USMC',[]]];

_c = _c + ['MtvrRepair'];
_i = _i + [['','',2500,22,-2,2,1,0,'USMC',[]]];
...
/* Air Vehicles */
_c = _c + ['MH60S'];
_i = _i + [['','',6528,35,-2,1,3,0,'USMC',[]]];

_c = _c + ['UH1Y'];
_i = _i + [['','',10522,40,-2,2,3,0,'USMC',[]]];

_c = _c + ['MV22'];
_i = _i + [['','',12672,43,-2,1,3,0,'USMC',[]]];

_c = _c + ['C130J'];
_i = _i + [['','',9440,52,-2,1,3,0,'USMC',[]]];

_c = _c + ['AH1Z'];
_i = _i + [['','',47632,60,-2,5,3,0,'USMC',[]]];

_c = _c + ['AH64D'];
_i = _i + [['','',34707,60,-2,4,3,0,'USMC',[]]];

_c = _c + ['F35B'];
_i = _i + [['','',53040,62,-2,5,3,0,'USMC',[]]];

_c = _c + ['AV8B'];
_i = _i + [['','',30280,65,-2,3,3,0,'USMC',[]]];

_c = _c + ['AV8B2'];
_i = _i + [['','',52556,65,-2,5,3,0,'USMC',[]]];

_c = _c + ['A10'];
_i = _i + [['','',48096,70,-2,4,3,0,'USMC',[]]];
