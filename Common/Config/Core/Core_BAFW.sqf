...
_i = _i + [['','',360,6,-1,3,0,1,'British (Woodland)',[]]];
...
_i = _i + [['','',230,5,-1,0,0,1,'British (Woodland)',[]]];
...
_c = _c + ['BAF_Offroad_W'];
_i = _i + [['','',375,13,-2,1,1,0,'British (Woodland)',[]]];

_c = _c + ['BAF_Jackal2_GMG_W'];
_i = _i + [['','',965,20,-2,2,1,0,'British (Woodland)',[]]];

_c = _c + ['BAF_Jackal2_L2A1_W'];
_i = _i + [['','',725,21,-2,2,1,0,'British (Woodland)',[]]];

/* Heavy Vehicles */
_c = _c + ['BAF_FV510_W'];
_i = _i + [['','',5000,30,-2,2,2,0,'British (Woodland)',[]]];
