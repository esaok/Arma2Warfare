...
_i = _i + [['','',300,6,-1,2,0,1,'PMC',[]]];

_c = _c + ['Soldier_AT_PMC'];
_i = _i + [['','',260,6,-1,0,0,1,'PMC',[]]];

_c = _c + ['Soldier_Bodyguard_AA12_PMC'];
_i = _i + [['','',325,6,-1,3,0,1,'PMC',[]]];

_c = _c + ['Soldier_Bodyguard_M4_PMC'];
_i = _i + [['','',225,6,-1,0,0,1,'PMC',[]]];

_c = _c + ['Soldier_Crew_PMC'];
_i = _i + [['','',170,6,-1,0,0,1,'PMC',[]]];

_c = _c + ['Soldier_Engineer_PMC'];
_i = _i + [['','',270,6,-1,2,0,1,'PMC',[]]];

_c = _c + ['Soldier_GL_M16A2_PMC'];
_i = _i + [['','',185,6,-1,0,0,1,'PMC',[]]];

_c = _c + ['Soldier_GL_PMC'];
_i = _i + [['','',260,6,-1,2,0,1,'PMC',[]]];

_c = _c + ['Soldier_M4A3_PMC'];
_i = _i + [['','',210,6,-1,1,0,1,'PMC',[]]];

_c = _c + ['Soldier_Medic_PMC'];
_i = _i + [['','',255,6,-1,2,0,1,'PMC',[]]];

_c = _c + ['Soldier_MG_PKM_PMC'];
_i = _i + [['','',190,6,-1,0,0,1,'PMC',[]]];

_c = _c + ['Soldier_MG_PMC'];
_i = _i + [['','',260,6,-1,3,0,1,'PMC',[]]];

_c = _c + ['Soldier_Pilot_PMC'];
_i = _i + [['','',175,6,-1,0,0,1,'PMC',[]]];

_c = _c + ['Soldier_PMC'];
_i = _i + [['','',230,6,-1,0,0,1,'PMC',[]]];

_c = _c + ['Soldier_Sniper_KSVK_PMC'];
_i = _i + [['','',290,6,-1,0,0,1,'PMC',[]]];

_c = _c + ['Soldier_Sniper_PMC'];
_i = _i + [['','',275,6,-1,0,0,1,'PMC',[]]];

_c = _c + ['Soldier_TL_PMC'];
_i = _i + [['','',280,6,-1,0,0,1,'PMC',[]]];

/* Light Vehicles */
_c = _c + ['SUV_PMC'];
_i = _i + [['','',300,20,-2,1,1,0,'PMC',[]]];

_c = _c + ['ArmoredSUV_PMC'];
_i = _i + [['','',800,25,-2,2,1,0,'PMC',[]]];
...
_c = _c + ['Ka137_MG_PMC'];
_i = _i + [['','',3500,35,-2,1,3,0,'PMC',[]]];

_c = _c + ['Ka60_PMC'];
_i = _i + [['','',6000,43,-2,2,3,0,'PMC',[]]];

_c = _c + ['Ka60_GL_PMC'];
_i = _i + [['','',6500,45,-2,2,3,0,'PMC',[]]];
