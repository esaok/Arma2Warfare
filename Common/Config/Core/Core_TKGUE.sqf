...
_c = _c + ['V3S_Repair_TK_GUE_EP1'];
_i = _i + [['','',425,17,-2,2,1,0,'Takistani Guerilla',[]]];

_c = _c + ['V3S_Salvage_TK_GUE_EP1'];
_i = _i + [['','',450,17,-2,1,1,0,'Takistani Guerilla',[]]];

_c = _c + ['V3S_Reammo_TK_GUE_EP1'];
_i = _i + [['','',450,18,-2,1,1,0,'Takistani Guerilla',[]]];

_c = _c + ['V3S_Refuel_TK_GUE_EP1'];
_i = _i + [['','',400,19,-2,0,1,0,'Takistani Guerilla',[]]];

_c = _c + ['V3S_Supply_TK_GUE_EP1'];
_i = _i + [['','',450,21,-2,0,1,0,'Takistani Guerilla',[]]];

_c = _c + ['BRDM2_TK_GUE_EP1'];
_i = _i + [['','',600,25,-2,3,1,0,'Takistani Guerilla',[]]];

_c = _c + ['BTR40_TK_GUE_EP1'];
_i = _i + [['','',650,25,-2,1,1,0,'Takistani Guerilla',[]]];

_c = _c + ['BTR40_MG_TK_GUE_EP1'];
_i = _i + [['','',800,25,-2,2,1,0,'Takistani Guerilla',[]]];
...
_i = _i + [['','',950,25,-2,2,1,0,'Takistani Guerilla',[]]];

/* Heavy Vehicles */
_c = _c + ['T34_TK_GUE_EP1'];
_i = _i + [['','',2400,30,-2,1,2,0,'Takistani Guerilla',[]]];
...
_c = _c + ['DSHkM_Mini_TriPod_TK_GUE_EP1'];
_i = _i + [['','',200,0,1,0,'Defense',0,'Takistani Guerilla',[]]];
...
_i = _i + [['Podnos 2B14','',1025,0,1,0,'Defense',0,'Takistani Guerilla',[]]];

_c = _c + ['D30_TK_GUE_EP1'];
_i = _i + [['','',2800,0,1,0,'Defense',0,'Takistani Guerilla',[]]];
